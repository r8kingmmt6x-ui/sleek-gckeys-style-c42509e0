            ...
            <div>
              <div className="bg-card border border-border rounded-2xl p-6 mb-6">
                ...
                <div className="mt-6 pt-6 border-t border-border">
                  ...
                  <div className="flex items-center gap-2 overflow-x-auto md:overflow-visible md:flex-nowrap scrollbar-hide">
                    {[
                      ...
                      <div
                        key={method.name}
                        className="h-8 min-w-[44px] rounded-md border border-border bg-background px-2 flex items-center justify-center flex-shrink-0"
                        title={method.name}
                      >
                        <img
                          src={method.icon}
